<header class="bg-gray-700 sticky top-0" style="z-index: 900" x-data="dropdown()">
    <div class="container-menu flex items-center h-16 justify-between md:justify-start">
        <a :class="{'bg-opacity-100 text-orange-500': open}"
           x-on:click="show()" class="flex flex-col items-center justify-center order-last md:order-first px-6 sm:px-4 bg-white bg-opacity-25 text-white cursor-pointer font-semibold h-full">
        ...
        <div  dusk="user" class="mx-6 relative hidden md:block">
            @auth
                <x-jet-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-jet-dropdown-link dusk="orders" href="{{ route('orders.index') }}">
                            {{ __('My Orders') }}
                        </x-jet-dropdown-link>
    ...
    <nav id="navigation-menu"
        ...
        <div class="container-menu h-full hidden sm:block">
            <div x-on:click.outside="close()" class="grid grid-cols-4 h-full relative">
                <ul class="bg-white">
